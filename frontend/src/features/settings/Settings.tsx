                        ...
                        <Grid size={{ xs: 12, md: 5 }}>
                            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                                <Box>
                                    ...
                                    <Typography variant="body1" fontWeight={700}>Dautari Adda</Typography>
                                </Box>
                                <Box>
                                    <Typography variant="caption" color="text.secondary" fontWeight={700}>EMAIL ADDRESS</Typography>
                                    <Typography variant="body1">info@dautariadda.com</Typography>
                                </Box>
                                <Box>
                        ...
                        <Grid size={{ xs: 12, md: 5 }}>
                            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                                <Box>
                                    ...
                                    <Typography variant="body1">Dautari Adda</Typography>
                                </Box>
                                <Box>
