                                ...
                                {loading ? (
                                    ...
                                    filteredContent().map((item: any) => (
                                        <TableRow key={item.id} hover>
                                            ...
                                            {tab === 0 && <TableCell sx={{ fontWeight: 700 }}>Rs. {item.price}</TableCell>}
                                            <TableCell>
                                                <Box sx={{
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, pt: 1 }}>
                        {tab === 0 ? (
                            <>
                                ...
                                <TextField label="Price" type="number" fullWidth required value={itemForm.price} onChange={(e) => setItemForm({ ...itemForm, price: e.target.value })} InputProps={{ startAdornment: <InputAdornment position="start">Rs.</InputAdornment> }} />
